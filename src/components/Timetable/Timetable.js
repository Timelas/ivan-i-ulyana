  ...
  return (
    <section className="timetable" id="plan">
      ...
      <div className="timetable__block">
        ...
        <p className="timetable__text timetable__text_about_rings">Welcome и<br />сбор гостей<br />15.00</p>
        <p className="timetable__text timetable__text_about_foto">Выездная регистрация<br />16.00</p>
